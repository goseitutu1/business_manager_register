                        ...
                        <p><span class="text-bold-600"><i class="ft-info"></i></span> {{$page->section}}</p>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        <label>Feature Image : <em style="font-size: 0.8em;color:red">Dimensions: 7360px X 3119px</em></label>
                                        <input type="file" class="form-control" accept="image/*" name="feature_image" required>
                                    </div>
                                    {{-- <div class="form-group col-lg-4">
