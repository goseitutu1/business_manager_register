                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Auto Generated"
                                            id="expense_no" value="{{ old('expense_no') }}" disabled>
                                    </div>
                                    <div class=" form-group col-md-3">
                                        <label for="total_amount">Total Amount</label>
                                        <input type="text" class="form-control" name="total_amount"
                                            placeholder="eg. 2000" id="total_amount" value="{{ old('total_amount') }}"
                                            required>
                                    </div>
                                    <div class=" form-group col-md-3">
                                        <label for="cost_price">Amount Paid</label>
                                        <input type="text" class="form-control" name="amount_paid"
                                            placeholder="eg. 2000" id="amount_paid" value="{{ old('amount_paid') }}">
                                    </div>
                                    <div class=" form-group col-md-3">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control" name="type" id="type" required>
                                            ...
                                            <option value="owing" {{ old('type') == 'owing' ? 'selected': '' }}>
                                                Owing Expense
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="vendor_id" id="vendor_id" required>
                                                ...
                                                <option value="{{ @$item->id }}"
                                                    {{ $item->id == old('vendor_id') ? 'selected' : '' }}>
                                                    {{ $item->full_name }}
                                                </option>
                                                @endforeach
                                            </select>
