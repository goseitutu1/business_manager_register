                            ...
                            <form method="post" id="form">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control" name="salary_due_date"
                                               id="salary_due_date" value="{{ old('salary_due_date') }}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control" name="salary_reminder" id="salary_reminder">
                                            ...
                                            <option value="monthly" {{ old('salary_reminder') == 'monthly' ? 'selected' : ''}}>Monthly</option>
                                        </select>
                                    </div>
                                </div>
