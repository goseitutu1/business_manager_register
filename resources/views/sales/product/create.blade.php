                    ...
                    <div class="card-body">
                        ...
                        <form method="post" id="sales">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <a  href="{{ route('customer.create', ['next' => route('sales.product.create', [], false)]) }}">
                            ...
                            <div class="form-row" id="cash-sales">
                                {{-- <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="payment_method" id="payment_method">
                                        ...
                                        <option value="momo-pay"
                                            {{ old('payment_method') == 'momo-pay' ? 'selected': '' }}>Mobile
                                            Money</option>
                                ...
                                {{-- <div class=" form-group col-md-4" id="phone_number">
                                    <label for="phone_number">Mobile Money Number</label>
                                    <input type="text" class="form-control" name="phone_number"
                                        placeholder="eg. 0248895123" value="{{ old('phone_number') }}" required>
                                </div> --}}
                                <div class=" form-group col-md-4">
                            ...
                            <div class="form-row">
                                {{-- <div class=" form-group col-md-4" id="cheque_block" style="display: none">
                                    <label for="cost_price">Cheque Number</label>
                                    <input type="text" class="form-control" name="cheque_number" placeholder="eg. 12334562"
                                           id="cheque_number" value="{{ old('cheque_number') }}">
                                </div> --}}
                                <div class=" form-group col-md-4" id="credit-sales">
