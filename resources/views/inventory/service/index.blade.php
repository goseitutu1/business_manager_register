        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="offset-md-9 col-md-3 text-right">
                    <form method="post" enctype="multipart/form-data" action="{{ route('inventory.service.import') }}" id="form">
                        @csrf
                        <div class="dropdown">
                            <a class="btn btn-secondary dropdown-toggle mr-5" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             Import
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('inventory.service.download_template') }}">Download Template</a>
